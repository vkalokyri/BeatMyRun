...
public class ViewAllChallenges extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(Config.URL_GET_ALL,sender_id);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String empId = map.get(Config.TAG_SAL).toString();
        String recId = map.get(Config.TAG_NAME).toString();

        intent.putExtra(Config.EMP_ID,empId);
        intent.putExtra(Config.REC_ID, recId);
        // intent.putExtra(Config.SENDER_ID,sender_id);
