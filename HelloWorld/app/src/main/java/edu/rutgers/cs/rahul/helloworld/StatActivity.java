...
//        setContentView(R.layout.selectpage);
        ...
        //Button wbutton = (Button) findViewById(R.id.btn_chart);
        Button wbutton = (Button) findViewById(R.id.button1);
        Button mbutton = (Button) findViewById(R.id.button2);

        //Button showchart1 = (Button) findViewById(R.id.chart1);
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            Intent new_screen = new Intent(getApplication(),StatGraphActivity.class);
...
//setting max values to be display in x axis
        ...
        mChart = ChartFactory.getBarChartView(StatActivity.this, dataset, multiRenderer, BarChart.Type.DEFAULT);
